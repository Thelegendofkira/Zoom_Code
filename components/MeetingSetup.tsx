...
function MeetingSetup({onSetupComplete}:{onSetupComplete:()=>void}) {
    ...
    const[isMicDisable,setIsMicDisable]=useState(false);
    const call=useCall();
    if(!call)return null;
    useEffect(()=>{
    ...
    useEffect(()=>{
        if(isMicDisable)call.microphone.disable();
        else call.microphone.enable();

    },[isMicDisable,call.microphone])
              ...
              <div className="flex-1 flex flex-col justify-between">
                <div className="spacey-6 mt-8">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      checked={!isMicDisable}
                      onCheckedChange={(checked) => setIsMicDisable(!checked)}
                    />
                  </div>
